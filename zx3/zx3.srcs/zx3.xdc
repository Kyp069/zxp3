...
#create_generated_clock -name spiCk -source [get_pins demistify/controller/spi/spiclk_out] -multiply_by 1 [get_pins demistify/controller/spi/spiclk_out]
#set_clock_groups -asynchronous -group [get_clocks clock50] -group [get_clocks -of_objects [get_pins mmcm/mmcm_adv_inst/CLKOUT0]] -group [get_clocks -of_objects [get_pins mmcm/mmcm_adv_inst/CLKFBOUT]] -group [get_clocks spiCk]
set_clock_groups -asynchronous -group [get_clocks clock50] -group [get_clocks -of_objects [get_pins mmcm/mmcm_adv_inst/CLKOUT0]] -group [get_clocks -of_objects [get_pins mmcm/mmcm_adv_inst/CLKFBOUT]]

set_property PACKAGE_PIN P19 [get_ports {sync[1]}]
set_property PACKAGE_PIN V18 [get_ports {sync[0]}]

set_property PACKAGE_PIN W17 [get_ports {rgb[17]}]
set_property PACKAGE_PIN AA19 [get_ports {rgb[16]}]
set_property PACKAGE_PIN AB20 [get_ports {rgb[15]}]
set_property PACKAGE_PIN V20 [get_ports {rgb[14]}]
set_property PACKAGE_PIN Y19 [get_ports {rgb[13]}]
set_property PACKAGE_PIN P20 [get_ports {rgb[12]}]

set_property PACKAGE_PIN W22 [get_ports {rgb[11]}]
set_property PACKAGE_PIN AA21 [get_ports {rgb[10]}]
set_property PACKAGE_PIN Y22 [get_ports {rgb[9]}]
set_property PACKAGE_PIN AB22 [get_ports {rgb[8]}]
set_property PACKAGE_PIN W20 [get_ports {rgb[7]}]
set_property PACKAGE_PIN V17 [get_ports {rgb[6]}]

set_property PACKAGE_PIN W21 [get_ports {rgb[5]}]
set_property PACKAGE_PIN W19 [get_ports {rgb[4]}]
set_property PACKAGE_PIN AA20 [get_ports {rgb[3]}]
set_property PACKAGE_PIN Y21 [get_ports {rgb[2]}]
set_property PACKAGE_PIN AB21 [get_ports {rgb[1]}]
...
set_property PACKAGE_PIN U6 [get_ports {i2sOut[2]}]
set_property PACKAGE_PIN U7 [get_ports {i2sOut[1]}]
set_property PACKAGE_PIN V9 [get_ports {i2sOut[0]}]

# internal midi (middleboard)
# {
set_property PACKAGE_PIN AB7 [get_ports midi]
set_property PACKAGE_PIN AB8 [get_ports {i2sIn[2]}]
set_property PACKAGE_PIN Y8 [get_ports {i2sIn[1]}]
set_property PACKAGE_PIN AA8 [get_ports {i2sIn[0]}]
# }

# external midi (SAM board connected to edge)
# {
#set_property PACKAGE_PIN H2 [get_ports midi]
#set_property PACKAGE_PIN H3 [get_ports {i2sIn[2]}]
#set_property PACKAGE_PIN C2 [get_ports {i2sIn[1]}]
#set_property PACKAGE_PIN J5 [get_ports {i2sIn[0]}]
# }
...
set_property PACKAGE_PIN T19 [get_ports fshCs]
set_property PACKAGE_PIN T4 [get_ports fshCk]
set_property PACKAGE_PIN R21 [get_ports fshRst]
set_property PACKAGE_PIN P22 [get_ports fshMosi]
set_property PACKAGE_PIN R22 [get_ports fshMiso]
...
set_property IOSTANDARD LVCMOS33 [get_ports i2sIn*]
set_property IOSTANDARD LVCMOS33 [get_ports i2sOut*]
...
set_property IOSTANDARD LVCMOS33 [get_ports fsh*]
...
set_property PULLUP true [get_ports fshMiso]
